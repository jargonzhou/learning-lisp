...
(comment
  ...
  ;; FIXME (map for [:foo :bar])    ; can't take value of a macro
...
(comment
  ...
  ;; FIXME (add-coords-3 {:x 3 :y 4})
  ;; FIXME (add-coords-3 {:x 2 :y 4}
  ;;               {:x -4 :y -4})
